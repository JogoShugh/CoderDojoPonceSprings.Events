...
* [Basic HTML for Kids](http://pluralsight.com/training/courses/TableOfContents?courseName=teaching-kids-basic-html) (1 hour video course) -- *Every web programmer at some point will need to know the basics of HTML. This course covers the basics of the HTML Language including tags and their attributes.*
* [Learn to program with C# and Turtles](http://www.pluralsight.com/training/Courses/TableOfContents/teaching-kids-programming) (1h) -- *Take this course to learn to program with C# and animating turtles!*
